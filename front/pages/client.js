...
function Client() {
    ...
    async function deleteClient(_id){
        ...
        let result = await fetch('http://localhost:4000/utilisateur/supprimerutl/'+_id , {
          method: 'DELETE'
        });
      ...
      async function getClient(){
        let result = await fetch("http://localhost:4000/utilisateur/getutilisateurs"); 
        result = await result.json();
        setData(result)
      ...
      async function searchClient(key){
        console.warn(key)
        let result = await fetch('http://localhost:4000/searchClient/'+key);
        result= await result.json();
        console.warn(result)
       setData(result)
    }
